    ...
    <section id="home" className="relative flex items-center justify-center scroll-mt-20 mt-15  mb:mt-20">
      ...
      <div className="absolute font-serif inset-0 z-1 flex flex-col items-center justify-center text-center px-4">
        <div className="flex items-center text-[#5C423E] font-bold fade-in md:text-5xl gap-4 text-4xl">
          <h1 className="text-4xl font-serif bg-gradient-to-r from-gray-300 via-gray-500 to-white bg-clip-text text-transparent md:text-8xl">Samilla</h1>
          <span className="bg-clip-text bg-gradient-to-r from-gray-300 via-gray-500 to-white text-transparent md:text-8xl">Maia</span>
        </div>
        <h2 className="text-[#E5C158] min-h-[3rem] text-xl   md:text-5xl font-bold fade-in mt-4">Estética Avançada</h2>
